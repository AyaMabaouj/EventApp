                ...
                VStack{
                    ...
                    HStack(spacing: -5)
                    {
                        ...
                        if(event.performers.count > 3){
                            Text("+\(event.performers.count - 3)   Going").font(.custom(Fonts.airbnbCereal_medium, size: 14)).foregroundColor(Colors.bleu).padding(.trailing, 16)
...
struct EventHItemView_Previews: PreviewProvider {
    static var previews: some View {
        EventHItemView(event:  Event(date: "Sat, May 1 •2:00 PM", image: "jazz", title: "A Virtual Evening of Smooth Jazz A Virtual Evening of Smooth Jazz A Virtual Evening of Smooth Jazz A Virtual Evening of Smooth Jazz", location: "Lot 13 • Oakland, CA", performers: [Performer(image: "jazz"),Performer(image: "jazz"),Performer(image: "jazz"),Performer(image: "jazz"),Performer(image: "jazz"),Performer(image: "jazz")]))
    }
}
